...
class MainActivity : AppCompatActivity() {
    ...
    private fun setUpWebView(serverUrl: String, roomCode: String, name: String) {
        ...
        // Android WebViews block third-party cookies by default. The Spotify
        // tab embeds open.spotify.com inside an iframe inside THIS page —
        // that's a third-party context, and without this, Spotify's embed
        // can never read its own login/session cookie. The practical effect
        // was worse than just "always shows the 30-second preview" (which
        // happens anyway without Premium) — it could fail to initialize at
        // all, since parts of Spotify's embed rely on that cookie being
        // readable during setup, not just during playback.
