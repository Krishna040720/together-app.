...
async function startScreenShare() {
  ...
  $("screenShareLabel").textContent = "You're sharing your screen";
  $("screenShareLabel").classList.remove("hidden");

  $("screenShareBtn").classList.add("active");
  $("startScreenShareBtn").textContent = "Stop sharing";

  track.onended = stopScreenShare; // user clicked the browser's native "Stop sharing" button
}
...
function stopScreenShare() {
  ...
  if (screenSender && pc) {
    try { pc.removeTrack(screenSender); } catch (e) {}
    screenSender = null;
    renegotiate();
  }
  $("screenShareVideo").classList.add("hidden");
